...
namespace Mango.Services.OrderAPI.Controllers
{
    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public OrderAPIController(AppDbContext db, IProductService productService,
            IMapper mapper, IRabbitMQOrderMessageSender messageBus, IConfiguration configuration)
        {
            _db = db;
        ...
        public async Task<ResponseDto> CreateOrder([FromBody] CartDto cartDto)
        {
            try
            {
                OrderHeaderDto orderHeaderDto =
                    _mapper.Map<OrderHeaderDto>(cartDto.CartHeader);

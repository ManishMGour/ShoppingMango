...
{
    public class RabbitMQOrdertMessageSender : IRabbitMQOrderMessageSender
    {
        ...
        public RabbitMQOrdertMessageSender()
        {
            _hostName = "localhost";
            _username = "guest";
            _password = "guest";
        ...
        public void SendMessage(object message, string exchangeName)
        {
            if (ConnectionExists())
            {
                ...
                channel.QueueBind(OrderCreated_EmailUpdateQueue,
                    exchangeName, "EmailUpdate");
                channel.QueueBind(OrderCreated_RewardsUpdateQueue,
                    exchangeName, "RewardsUpdate");
